<template>
	<div class="home column xlarge-half large-two-third medium-20 small-full">
		...
		<Content custom/>
		<div class="footer">
			MIT Licensed | Copyright © 2018-present Matise Amsterdam
		</div>
	</div>
</template>
...
import * as animationData from './c.json';
